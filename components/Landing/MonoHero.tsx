    ...
    <header className="relative isolate overflow-hidden bg-white py-10 lg:py-20">
      ...
      <nav className="container mx-auto flex items-center justify-between px-6 md:px-8 lg:px-12 absolute top-0 left-0 right-0 z-10 pt-8">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#features" className="text-sm font-medium text-neutral-800! hover:text-black transition">Features</a>
          ...
          <div className="md:col-span-7 max-w-3xl mx-auto md:mx-0 text-center md:text-left">
            ...
            <div className="mt-12 flex items-center gap-6 justify-center md:justify-start text-sm text-neutral-600">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full border border-neutral-200 bg-neutral-50 flex items-center justify-center text-sm font-semibold text-black">1</div>
                <div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full border border-neutral-200 bg-neutral-50 flex items-center justify-center text-sm font-semibold text-black">99%</div>
                <div>
